...
export const rentalDisclaimer =
  'Rental rules, availability, and income potential vary by property, location, HOA, and local regulations. Jason can help you evaluate property-specific considerations.';
